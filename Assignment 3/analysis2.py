...
def print_stats(word_and_punctuation_instances, within_sentence_punctuation, \
    ...
    # expression.
    print("Number of distinct words:", format(num_distinct, '.2f'))
    print("Number of words:", format(num_words, '.2f'))
    print("Average word length:", format(avg_word_length, '.2f'))
    print("Number of sentences:", format(num_sentences, '.2f'))
